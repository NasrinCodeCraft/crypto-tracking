    ...
    return (
        ...
        px-4 sm:px-[5%] py-6 md:py-10 relative z-0'>
            ...
            <div className='text-center mb-8 md:mb-12 space-y-4 group relative'>
                ...
                <p className='text-gray-300/80 max-w-xl mx-auto text-sm sm:tetx-base md:text-lg leading-relaxedmt-4'>
                    Track real-time market metrics with advanced analytics and
            ...
            {/* TASK HEADER */}
            <div className='hidden md:grid grid-cols-5 gap-4 text-sm py-4 mb-2 bg-gray-800/40 backdrop-blur-lg rounded-xl
